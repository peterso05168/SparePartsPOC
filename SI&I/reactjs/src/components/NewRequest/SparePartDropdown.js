...
class SparePartDropdown extends React.Component<SparePartDropdownProps> {

	render () {
		const { dropdownLabel, dropdownList, seletedValue, classes, helperText, handleChange } = this.props;
		const { selectEmpty } = classes;
		return (
			<div style={{ padding: 0 }}>
				<Select
...
export default withStyles(styles)(SparePartDropdown);
